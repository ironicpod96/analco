 ...
 * | Task Completion  | vision (client only)    | 2–4 step screenshots (client) / 2 radios          | AI scores client from step sequence;  |
 * |                  |                         |   (ease, duration) for competitors                |   competitors use sum of 2 radios     |
